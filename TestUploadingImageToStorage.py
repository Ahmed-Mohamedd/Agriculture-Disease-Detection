...
def uploadImage(imagename , i):
    ...
    blob = bucket.blob(f'UploadedImage{i}')
    ...
    u = f'https://firebasestorage.googleapis.com/v0/b/agriculture-project-691c0.appspot.com/o/UploadedImage{i}?alt=media&token='+token
    return u
